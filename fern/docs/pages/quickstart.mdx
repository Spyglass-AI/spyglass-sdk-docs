...
Works with OpenTelemetry and supports first-class instrumentation for OpenAI.
...
- **Example Project**: Check out our [complete example](https://github.com/Spyglass-AI/example-project)
